...
public class ChupiaoxinxiController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,ChupiaoxinxiEntity chupiaoxinxi,
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,ChupiaoxinxiEntity chupiaoxinxi, 
		HttpServletRequest request){
        EntityWrapper<ChupiaoxinxiEntity> ew = new EntityWrapper<ChupiaoxinxiEntity>();
		PageUtils page = chupiaoxinxiService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, chupiaoxinxi), params), params));
        return R.ok().put("data", page);
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<ChupiaoxinxiEntity> wrapper = new EntityWrapper<ChupiaoxinxiEntity>();
		if(map.get("remindstart")!=null) {
