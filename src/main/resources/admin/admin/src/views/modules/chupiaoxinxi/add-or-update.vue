<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="出票码" prop="chupiaoma">
            <el-input v-model="ruleForm.chupiaoma" 
                placeholder="出票码" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.chupiaoma" label="出票码" prop="chupiaoma">
              <el-input v-model="ruleForm.chupiaoma" 
                placeholder="出票码" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="出票时间" prop="chupiaoshijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.chupiaoshijian" 
                type="datetime"
                :readonly="ro.chupiaoshijian"
                placeholder="出票时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.chupiaoshijian" label="出票时间" prop="chupiaoshijian">
              <el-input v-model="ruleForm.chupiaoshijian" 
                placeholder="出票时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  ...
  created() {
	this.ruleForm.chupiaoshijian = this.getCurDateTime()
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xiadanshijian = true;
          ...
          if(o=='chupiaoma'){
            this.ruleForm.chupiaoma = obj[o];
	    this.ro.chupiaoma = true;
            continue;
          }
          if(o=='chupiaoshijian'){
            this.ruleForm.chupiaoshijian = obj[o];
	    this.ro.chupiaoshijian = true;
            continue;
          }
        }
      }
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `chupiaoxinxi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.chupiaoxinxiCrossAddOrUpdateFlag = false;
						 this.parent.search();
